...
let clikedAdd=()=>{
  ...
  return <div className="container">
      <div className="row my-row">
        <div className="col-4"><input ref={nameElement} className={styles["input"]} type="text"  placeholder="Enter Todo Here" /></div>

        <div className="col-4"><input ref={dateElement} className={styles["input"]} type="date" /></div>
